	...
	Music.prototype._play = function() {
		...
		// if ( this.player.networkState === 1) {
			...
			this.bufferedTimer = setInterval(function () {
				...
				if (bufferedPercent >= 100) clearInterval( self.bufferedTimer );
